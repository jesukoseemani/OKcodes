...
const initialSchema = createSchema({
  nodes: [
    ...
    { id: "node-2", content: <Content video={netflixVideo} img={netflix} title="netflix" link="https://glueflix-68809.web.app" />, coordinates: [200, 0] },
    { id: "node-3", content: <Content video={whatsappVideo} img={whatsapp} title="whatsapp" link="https://whats-app-phi.vercel.app"  />, coordinates: [300, 100] },
    { id: "node-4", content:<Content video={disneyVideo} img={facebook} title="facebook" link="https://facebook-theta.vercel.app" />, coordinates: [400, 200] },
    { id: "node-5", content: <Content video={whatsappVideo} img={discord} title="discord" link="https://discordclonen.netlify.app" />, coordinates: [500, 300] },
    { id: "node-6", content: <Content video={facebookVideo} img={disney} title="disney" link="https://disney-7de41.web.app/" />, coordinates: [600, 400] }
  ],
  links: [
