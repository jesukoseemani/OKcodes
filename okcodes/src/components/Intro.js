		...
		<Styledintro>
			...
			<Introcontainer>
				...
				<motion.div variants={fade} className='intro_content'>
					...
					<p>
						I am Front-End Developer from Nigeria. I like progressive web apps
					...
					<div className='social'>
						...
						<a
							className='linkedin'
							href='https://www.linkedin.com/in/koseemani/'>
